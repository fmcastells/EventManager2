...
//    }
    ...
    public List<Event> getEventsBetweenSpecificPeriod(@RequestParam LocalDateTime from, @RequestParam LocalDateTime to ) {
        return es.getEventsBetweenSpecificPeriod(from,to);
}
}
